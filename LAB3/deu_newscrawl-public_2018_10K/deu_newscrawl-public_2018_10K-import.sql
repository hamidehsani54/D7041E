CREATE DATABASE `deu_newscrawl-public_2018_10K`;

USE deu_newscrawl-public_2018_10K;
...
CREATE TABLE `words` (
  ...
  KEY `word` (`word`),
  KEY `w_id` (`w_id`)
) ENGINE=MyISAM AUTO_INCREMENT=36939 DEFAULT CHARSET=utf8;
...
CREATE TABLE `sources` (
  ...
  KEY `so_id` (`so_id`),
  KEY `date` (`date`)
) ENGINE=MyISAM AUTO_INCREMENT=9928 DEFAULT CHARSET=utf8;
...
LOAD DATA LOCAL INFILE 'deu_newscrawl-public_2018_10K-words.txt' INTO TABLE words;
LOAD DATA LOCAL INFILE 'deu_newscrawl-public_2018_10K-sentences.txt' INTO TABLE sentences;
LOAD DATA LOCAL INFILE 'deu_newscrawl-public_2018_10K-co_s.txt' INTO TABLE co_s;
LOAD DATA LOCAL INFILE 'deu_newscrawl-public_2018_10K-co_n.txt' INTO TABLE co_n;
LOAD DATA LOCAL INFILE 'deu_newscrawl-public_2018_10K-inv_w.txt' INTO TABLE inv_w;
LOAD DATA LOCAL INFILE 'deu_newscrawl-public_2018_10K-inv_so.txt' INTO TABLE inv_so;
LOAD DATA LOCAL INFILE 'deu_newscrawl-public_2018_10K-sources.txt' INTO TABLE sources;
